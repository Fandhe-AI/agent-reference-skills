...
Background on the Drizzle project's funding model, core team, and revenue streams.

## Signature / Usage

```bash
# get-started/postgresql-new.mdx: installing the open-source drizzle-orm core package
...
- This page has no code examples in the source doc; the install command above is quoted from `get-started/postgresql-new.mdx` (also cited in `get-started.md`) as the representative "getting started" snippet for the open-source `drizzle-orm` package that this sustainability model funds.
