...
|------|-------------|------|
| Choose your Windows AI solution | Decision guide for AI solution selection: Windows AI APIs, Foundry Local, Windows ML, cloud | [choose-your-windows-ai-solution.md](./choose-your-windows-ai-solution.md) |
| Content moderation with Windows AI APIs | Content moderation with configurable severity levels for prompt/response/image | [content-moderation.md](./content-moderation.md) |
| Device requirements and fallback | Check device readiness via AIFeatureReadyState and handle unsupported hardware | [device-requirements.md](./device-requirements.md) |
| ImageDescriptionGenerator | Generate natural-language text description from image content | [image-description-generator.md](./image-description-generator.md) |
| ImageForegroundExtractor | Extract foreground/background mask for background removal and sticker generation | [image-foreground-extractor.md](./image-foreground-extractor.md) |
| ImageGenerator | Text-to-image, restyle, magic fill, and coloring-book generation via Stable Diffusion | [image-generator.md](./image-generator.md) |
...
| Semantic Search and embeddings | Generate embeddings for semantic search and Retrieval-Augmented Generation (RAG) | [semantic-search.md](./semantic-search.md) |
