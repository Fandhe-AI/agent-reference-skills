...
| PackageManager Class | `Windows.Management.Deployment.PackageManager` manages MSIX packages for a user | [package-manager.md](./package-manager.md) |
...
| Package Uninstall and Update Behavior | How a package is uninstalled/updated depends on its packaging model | [package-uninstall-update.md](./package-uninstall-update.md) |
| Sparse Packages and External Location Packages | Grants package identity to existing unpackaged apps without replacing installer or moving binaries | [sparse-packages-external-location.md](./sparse-packages-external-location.md) |
