...
Optional browser entry point in Framework Mode. Hydrates server-rendered markup on the client. React Router provides a default implementation when this file is absent. Not available in Data Mode or Declarative Mode.
...
- v8: content confirmed current against `reactrouter.com/api/framework-conventions/entry.client.tsx` (v8.3.0+). No renames/removals.
