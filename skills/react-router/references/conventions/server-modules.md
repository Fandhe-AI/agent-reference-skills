...
- v8: content confirmed current against `reactrouter.com/api/framework-conventions/server-modules` (v8.3.0+). No renames/removals. Available in Framework Mode only (not Data Mode or Declarative Mode).
