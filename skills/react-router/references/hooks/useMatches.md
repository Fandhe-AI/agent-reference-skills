...
| `params` | `Params<string>` | Dynamic route params |
| `loaderData` | `Data \| undefined` | Loader data for this route (may be `undefined` if the route's loader threw) |
| `handle` | `Handle` | The route module's `handle` export |
...
- [unstable_useRouterState](./useRouterState.md) — unified router state including `active.matches`
