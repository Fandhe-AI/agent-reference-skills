...
| StorageLibraryChangeTracker | Tracks add/delete/modify/rename/move operations on library files/folders… | [storage-library-change-tracker.md](./storage-library-change-tracker.md) |
| StorageProviderSyncRootManager | Registers/unregisters cloud storage provider sync roots with the OS. | [storage-provider-sync-root-manager.md](./storage-provider-sync-root-manager.md) |
